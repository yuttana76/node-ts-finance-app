...
import { ResponsiveContainer, PieChart, Pie, LineChart, CartesianGrid, XAxis, YAxis, Tooltip, Area, Line, Legend, Cell, ScatterChart, Scatter, ZAxis } from "recharts";
      ...
      <DashboardBox gridArea="e">
        ...
        <FlexBetween mt="0.25rem" gap="1.5rem" pr="1rem">
          ...
          <Box ml="-0.7rem" flexBasis="40%" textAlign="center" >
            ...
            <Typography variant="h6">Finance goals of the comapign that is desired.</Typography>
          </Box>
          <Box flexBasis="40%" >
      ...
      <DashboardBox gridArea="f">
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <ZAxis type="nmber" range={[20]} />
            <Tooltip formatter={(v) => `$${v}`} />
            <Scatter name="Product Expense Ratio" data={productExpenseData}
